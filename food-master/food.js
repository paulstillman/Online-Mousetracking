...
function instr_1aRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of instr_1aComponents)
...
function instr_1bRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of instr_1bComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instr_1cRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of instr_1cComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instr_1dRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of instr_1dComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instr_1eRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of instr_1eComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function choose_trialsLoopBegin(choose_trialsLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisChoose_trial of choose_trials) {
...
function begin_trialRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of begin_trialComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function practice_moveRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of practice_moveComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function time_warning_pRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of time_warning_pComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instr_1fRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of instr_1fComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function choose_moveRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of choose_moveComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function time_warningRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of time_warningComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instr_2aRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of instr_2aComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instr_2bRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of instr_2bComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instr_2cRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of instr_2cComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instr_2dRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of instr_2dComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function show_codeRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of show_codeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
